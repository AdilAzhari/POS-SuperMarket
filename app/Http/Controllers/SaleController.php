...
class SaleController extends Controller
{
    ...
    public function store(StoreSaleRequest $request): JsonResponse
    {
        try {
            ...
            return $e->render();
        } catch (\App\Exceptions\SaleProcessingException $e) {
    ...
    {
        // For POS systems, sales are typically immutable after creation
        // This endpoint could be used for status updates only
