...
it('can show a specific sale', function () {
...
it('returns error when insufficient stock', function () {
    // Set low stock
...
it('prevents sale updates', function () {
    $sale = Sale::factory()->create();
...
it('prevents sale deletion', function () {
    $sale = Sale::factory()->create();
...
it('decrements stock after sale', function () {
