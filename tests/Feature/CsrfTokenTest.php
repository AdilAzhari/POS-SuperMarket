...
test('csrf token is generated on web pages', function () {
...
test('post request without csrf token should fail', function () {
...
test('post request with valid csrf token should work', function () {
